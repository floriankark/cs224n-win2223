...
\newcommand\eqnl[2]{\begin{eqnarray} \label{eqn:#1} #2 \end{eqnarray}} %
\newcommand\eqdef{\ensuremath{\stackrel{\rm def}{=}}} %
...
\newcommand\cE[2]{\ensuremath{\E \left( #1 \mid #2 \right)}} %
\newcommand\KL[2]{\ensuremath{\T{KL}\left( #1 \,||\, #2 \right)}} %
\newcommand\D[2]{\ensuremath{\bD\left( #1 \,||\, #2 \right)}} %
